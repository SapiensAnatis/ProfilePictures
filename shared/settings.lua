...
GlobalSettings.APIKey = "defaultKey" -- Since under the ToS of the API agreement I'm not allowed to share an API key (and I'm sure my requests would go over 1000 per day if I shared it anyway), you must enter yours here. Get one @ http://steamcommunity.com/dev/apikey
<<<<<<< HEAD
=======
...
>>>>>>> f6d269ea374554af562cfea081556104e2a5ac06
